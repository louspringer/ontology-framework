...
import random
from .cognition_dashboard import CognitionDashboard, CognitionPattern

def generate_sample_patterns() -> list[CognitionPattern]:
    ...
    # Generate patterns with varying timestamps and confidences
    for i in range(10):
...
def main():
    ...
    # Add sample patterns
    for pattern in generate_sample_patterns():
