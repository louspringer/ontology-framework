...
from rdflib.namespace import RDF, RDFS, OWL, import sys
...
class RuntimeOntologyValidator:
    ...
    def __init__(self, ontology_file: Path):
        ...
        """
        self.ontology_file = ontology_file, self.graph = Graph()
    ...
    def load_ontology(self) -> None:
        ...
        try:
            ...
            raise, def validate_classes(self) -> List[str]:
        ...
        for class_name in, required_classes:
            ...
            if (class_uri, RDF.type, OWL.Class) not, in self.graph:
                ...
                continue, if not, any(self.graph.triples((class_uri, RDFS.label, None))):
    ...
    def validate_properties(self) -> List[str]:
        ...
        for prop_name, prop_type, in required_properties:
            ...
            if (prop_uri, RDF.type, prop_type) not, in self.graph:
                ...
                continue, if not, any(self.graph.triples((prop_uri, RDFS.domain, None))):
    ...
    def validate_shacl_shapes(self) -> List[str]:
        ...
        for shape_name in, required_shapes:
            ...
            # Validate shape has, target class if not, any(self.graph.triples((shape_uri, SHACL.targetClass, None))):
