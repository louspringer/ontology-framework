...
class OntologyValidator:
    ...
    def validate_validation_rules(self) -> Dict[str, List[str]]:
        ...
        for cls in required_classes:
            ...
            # Check required properties, for ValidationRule, if cls == "ValidationRule":
    ...
    def validate_shacl_shapes(self) -> Dict[str, List[str]]:
        ...
        for shape in required_shapes:
            ...
            # Check shape properties, if not, any(self.guidance_graph.triples((shape_uri, SH.targetClass, None))):
    ...
    def validate_integration_process(self) -> Dict[str, List[str]]:
        ...
        for prop in required_properties:
            ...
            # Check property domains, and ranges, if not, any(self.guidance_graph.triples((prop_uri, RDFS.domain, None))):
    ...
    def validate_against_target(self, target_path: Union[str, Path]) -> Dict[str, List[str]]:
        ...
        # Check properties
        guidance_properties = set(self.guidance_graph.subjects(RDF.type, OWL.DatatypeProperty))
        guidance_properties |= set(self.guidance_graph.subjects(RDF.type, OWL.ObjectProperty))
        target_properties = set(target_graph.subjects(RDF.type, OWL.DatatypeProperty))
        target_properties |= set(target_graph.subjects(RDF.type, OWL.ObjectProperty))
