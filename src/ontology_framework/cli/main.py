...
def mcp(ontology: Path, targets: tuple[Path, ...], verbose: bool, config: Path) -> None:
    ...
    # Print the results, click.echo("\n=== MCP, Prompt Results ===")
    
    # Discovery Phase Results, click.echo("\nDiscovery, Phase:")
    ...
    # Check Phase Results, click.echo("\nCheck, Phase:")
    check = results["check"]
