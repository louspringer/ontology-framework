...
class PDCAModelManager:
    ...
    def start_pdca_loop(self):
        ...
        self.graph.add((self.current_loop, RDF.type, PDCA.PDCALoop))
    ...
    def do_phase(self, plan_phase: URIRef) -> URIRef:
        ...
        # Link to current loop and plan phase
        self.graph.add((self.current_loop, PDCA.hasDoPhase, do_phase))
    ...
    def check_phase(self, do_phase: URIRef) -> URIRef:
        ...
        # Link to current loop and do phase
        self.graph.add((self.current_loop, PDCA.hasCheckPhase, check_phase))
    ...
    def act_phase(self, check_phase: URIRef) -> URIRef:
        ...
        # Link to current loop and check phase
        self.graph.add((self.current_loop, PDCA.hasActPhase, act_phase))
