from rdflib import (
    ...
    OWL,
    import os,
    def add_validation_rule(rule_name: str,
    rule_value: str):
)
    ...
    # Create the new, validation rule, rule_uri = ONT[rule_name]
...
if __name__ == "__main__":
    # Add the ONTOLOGY, validation rule, add_validation_rule("ONTOLOGY", "ontology") 