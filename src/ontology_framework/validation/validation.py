...
This module provides functionality for validating ontologies against various requirements, including SHACL constraints and custom validation rules.
"""
...
class ValidationManager:
    ...
    def add_validator(self, name: str, validator: callable) -> None:
        """Add a custom validator by name."""
