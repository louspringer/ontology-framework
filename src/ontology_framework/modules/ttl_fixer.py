...
class SHACLShapeBuilder:
    ...
    def __init__(self, graph: Graph, base_ns: Namespace) -> None:
        ...
        Args:
            graph: The RDF graph to add shapes to
            base_ns: The base namespace for the shapes
        """
        self.graph = graph
        self.base_ns = base_ns
        
    def create_node_shape(self, shape_name: str, target_class: Optional[URIRef] = None) -> URIRef:
        """Create a new SHACL NodeShape.
        
        Args:
            shape_name: The name of the shape
            target_class: Optional class that this shape targets
    ...
    def add_property_constraint(
        ...
        **kwargs: Union[URIRef, Literal, str, int]
        ...
        Args:
            shape: The shape to add the constraint to
            path: The property path this constraint applies to
    ...
    def fix_frequency_validation(self) -> None:
        ...
        for s, p, o in self.graph.triples((None, None, None)):
            if isinstance(o, Literal) and str(o).startswith("frequency:"):
                ...
                if "-" in freq_value:
                    # Range case
                    min_val, max_val = freq_value.split("-")
                    ...
                    try:
                        ...
                        self.graph.add((prop, SH.minCount, Literal(0)))
...
if __name__ == "__main__":
    # Fix guidance.ttl in the project root
    project_root = Path(__file__).parent.parent.parent
    input_path = project_root / "guidance.ttl"
