...
def convert_json_to_md(json_data):
    ...
    md_output += (
        f"**Q:** {json_data['conversation']['initial_question']['question']}\n\n"
    )
    ...
    md_output += (
        f"**Q:** {json_data['conversation']['memory_management']['question']}\n\n"
    )
    md_output += (
        f"**A:** {json_data['conversation']['memory_management']['answer']}\n\n"
    )
