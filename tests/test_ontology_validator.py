"""Tests for the ontology validator module."""

import pytest
from rdflib import Graph, Namespace, URIRef
from rdflib.namespace import RDF, RDFS, OWL, SH
from pathlib import Path
from src.ontology_framework.ontology_validator import OntologyValidator
...
@pytest.fixture
def valid_guidance_graph():
    """Create a valid guidance graph for testing."""
    g = Graph()
    g.parse(data=VALID_ONTOLOGY_DATA, format="turtle")
    return g

@pytest.fixture
def invalid_guidance_graph():
    """Create an invalid guidance graph for testing."""
    g = Graph()
    g.parse(data=INVALID_ONTOLOGY_DATA, format="turtle")
    return g
