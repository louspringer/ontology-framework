...
class TestAbemaTV(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        os.environ['ABEMA_HKEY'] = 'test_hkey'
    ...
    def test_real_extraction(self):
        ...
        with patch('yt_dlp.extractor.abematv.AbemaTVIE._download_webpage') as mock_webpage, \
             ...
             patch('yt_dlp.extractor.common.InfoExtractor._parse_m3u8_formats_and_subtitles') as mock_parse_m3u8:
            ...
            mock_webpage.return_value = test_html
...
'''
            ...
            mock_webpage_handle.return_value = (mock_m3u8_response, mock_url_handler)
            ...
            mock_parse_m3u8.return_value = (formats, {})
            ...
            info = extractor._real_extract('https://abema.tv/video/episode/test-123')
            ...
            logger.debug("Description - Expected: 'Test description', Got: %s", info.get('description'))
