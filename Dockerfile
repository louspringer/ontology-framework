...
CMD ["sh", "-c", "echo 'Starting BFG9K MCP Server...' && ls -la /app && echo 'Contents of /app/guidance.ttl:' && cat /app/guidance.ttl && echo 'Starting FastMCP...' && conda run --no-capture-output -n ontology-framework python -m ontology_framework.mcp.bfg9k_mcp_server"]