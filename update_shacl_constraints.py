from rdflib import Graph, URIRef, Literal, XSD, RDFS, OWL, RDF, BNode, RDF
...
def update_shacl_constraints():
    ...
    shapes_graph.add((label_property, SH.datatype, XSD.string))
    ...
    shapes_graph.add((label_property, SH.message, Literal("Validation target must have an English label")))
    ...
    shapes_graph.add((comment_property, SH.datatype, XSD.string))
    ...
    shapes_graph.add((comment_property, SH.message, Literal("Validation target must have an English comment")))
