...
from rdflib import Graph, URIRef, Literal, BNode, from rdflib.namespace import RDF, RDFS, OWL, XSD, from rdflib.term import Node, def generate_deployment_config():
    ...
    # Add ontology metadata, g.add((deployment, RDF.type, OWL.Ontology))
