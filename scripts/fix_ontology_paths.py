...
class OntologyPathFixer:
    ...
    def _convert_uri(self, uri: str) -> str:
        ...
        if uri.startswith("file:///"):
            # Remove file:/// and base path
            relative = uri.replace("file:///", "").replace(self.base_path, "")
    ...
    def fix_file(self, file_path: str) -> bool:
        ...
        Args:
            file_path: Path to the ontology file to fix
    ...
    def fix_all_files(self, directory: str = "guidance/modules") -> bool:
        ...
        # First fix guidance.ttl
        if not self.fix_file("guidance.ttl"):
